    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3 ">
                <h2 class="font-bold text-4xl text-white mb-5">AL-MADINAH</h2>
                <h3 class="font-bold text-2xl mb-2">Hubungi Kami</h3>
                <p>farhanmuti54@gmail.com / </p>
                <p>Jl. Hertasning Baru / </p>
                <p>Kec Kassi-Kassi / </p>
                <p>Makassar, Sulawesi Selatan / </p>
                <p>90111 / </p>
            </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                <h3 class="font-semibold text-xl text-white mb-5">Hobby</h3>
                <ul class="text-slate-300">
                    <li>
                        <a href="#" class="inline-block text-base text-white mb-3">Programming</a>
                    </li>
                    <li>
                        <a href="#" class="inline-block text-base text-white mb-3">Traveling</a>
                    </li>
                    <li>
                        <a href="#" class="inline-block text-base text-white mb-3">Olahraga</a>
                    </li>
                </ul>
            </div>
            <div class="w-full px-4 mb-12 md:w-1/3">
                ...
                <ul class="text-slate-300">
                    <li>
                        <a href="#" class="inline-block text-base text-white mb-3">Beranda</a>
                    </li>
                    <li>
                        <a href="#about" class="inline-block text-base text-white mb-3">Tentang Saya</a>
                    </li>
                    <li>
                        <a href="#portfolio" class="inline-block text-base text-white mb-3">Portfolio</a>
                    </li>
                    <li>
                        <a href="#skill" class="inline-block text-base text-white mb-3">Skills</a>
                    </li>
                    <li>
                        <a href="#hobby" class="inline-block text-base text-white mb-3">Hobby</a>
                    </li>
                    <li>
                        <a href="#contact" class="inline-block text-base text-white mb-3">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="w-full pt-10 border-t border-slate-700">
            <div class="flex item-center justify-center mb-5">
                <!-- Youtube -->
                <a href="https://www.youtube.com/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/muhammadfarhan_askar/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                ...
                <!-- Github -->
                <a href="https://github.com/farhan181206" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white">
            ...
            <p class="font-medium text-xs text-slate-500 text-center">Dibuat dengan <span>💜</span> oleh <a href="https://www.instagram.com/muhammadfarhan_askar/" target="_blank" class="font-bold text-primary">Muhammad Farhan,</a>  Menggunakan <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500"> Tailwind CSS.</a></p>
        </div>
    </div>
</footer>
<!-- Footer End --> --}}
